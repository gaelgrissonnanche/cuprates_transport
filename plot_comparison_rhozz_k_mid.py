...
######################################################
data = np.loadtxt("data_k_mid_meshxy_50.dat", dtype = "float", comments = "#")
...
line = axes.plot(x, y * 1e6, label = r"k mid meshxy 50")
plt.setp(line, ls ="-", c = color, lw = 3, marker = "", mfc = color, ms = 7, mec = color, mew= 2)
######################################################

######################################################
data = np.loadtxt("data_k_mid_meshxy_200.dat", dtype = "float", comments = "#")
...
line = axes.plot(x, y * 1e6, label = r"k mid meshxy 200")
plt.setp(line, ls ="-", c = color, lw = 3, marker = "", mfc = color, ms = 7, mec = color, mew= 2)
######################################################

######################################################
data = np.loadtxt("data_k_mid_meshxy_2000.dat", dtype = "float", comments = "#")
...
line = axes.plot(x, y * 1e6, label = r"k mid meshxy 2000")
plt.setp(line, ls ="-", c = color, lw = 3, marker = "", mfc = color, ms = 7, mec = color, mew= 2)
######################################################
