...
class BandStructure:
    def __init__(self, bandname="band0", a=3.75, b=3.75, c=13.2,
                 mu=-0.83,
                 t=190, tp=-0.136, tpp=0.068, tppp=0, tpppp=0,
...
if __name__ == '__main__':
    bandObject = BandStructure(a=3.75, b=3.75, c=13.2, mesh_ds=1, numberOfKz=1)
