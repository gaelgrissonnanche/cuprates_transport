...
## Yawen Grid
# grid_yawen = np.loadtxt("Fermi_grid_Yawen.dat")
# grid_yawen = np.transpose(grid_yawen)
# bandObject.kf = grid_yawen
# vx, vy, vz = bandObject.v_3D_func(bandObject.kf[0,:], bandObject.kf[1,:], bandObject.kf[2,:])
# bandObject.vf = np.vstack([vx, vy, vz])
# print(bandObject.kf.shape)
# print(bandObject.vf.shape)
...
# Data = Data.transpose()
# np.savetxt("Fermi_Surface_grid_Gael.dat", Data, fmt='%.7e',
...
condObject = Conductivity(bandObject, Bamp=45, Bphi=0, Btheta=0, gamma_0 = 2, gamma_k = 0, power = 0)
condObject.solveMovementFunc()
