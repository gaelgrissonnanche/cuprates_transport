...
hPocketCondObject = Conductivity(hPocket, Bamp=45, gamma_0=23.2, gamma_k=0, power=12, gamma_dos=0)
ePocketCondObject = Conductivity(ePocket, Bamp=45, gamma_0=23.2, gamma_k=0, power=12, gamma_dos=0)
start_total_time = time.time()
