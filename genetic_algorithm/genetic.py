...
## Data Nd-LSCO 0.21  >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>#
data_dict = {}  # keys (T, phi), content [filename, theta, rzz, theta_cut]
data_dict[25, 0] = ["../data_NdLSCO_0p21/NdLSCO_0p21_1808A_c_AS_T_25_H_45_phi_0.dat", 0, 2, 90]
data_dict[25, 15] = ["../data_NdLSCO_0p21/NdLSCO_0p21_1808A_c_AS_T_25_H_45_phi_15.dat", 0, 2, 90]
data_dict[25, 30] = ["../data_NdLSCO_0p21/NdLSCO_0p21_1808A_c_AS_T_25_H_45_phi_30.dat", 0, 2, 90]
data_dict[25, 45] = ["../data_NdLSCO_0p21/NdLSCO_0p21_1808A_c_AS_T_25_H_45_phi_45.dat", 0, 2, 90]
...
## Play
# genetic_search(init_member,ranges_dict, data_dict, folder="../data_NdLSCO_0p21",
...
# )
utils.fig_compare(init_member, data_dict, folder="../data_NdLSCO_0p21")
