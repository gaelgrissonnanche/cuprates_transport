...
#     "c": 13.2,
#     "energy_scale": 190,
#     "band_params":{"mu":-0.82439881, "t": 1, "tp":-0.13642799, "tpp":0.06816836, "tz":0.06512192, "tz_d":-0.001},
#     "res_xy": 20,
#     "res_z": 7,
#     # "fudge_vF": "1 + 5 * cos(2*atan2(ky, kx))**12",
#     "fixdoping": 2,
...
#     "data_T": 25,
#     "data_p": 0.24,
#     "epsilon_z": "- 2*tz*(cos(a*kx) - cos(b*ky))**2*cos(a*kx/2)*cos(b*ky/2)*cos(c*kz/2) - 2*tz_d*cos(c/2*kz)",
# }
