...
## Function residual ########
def residualFunc(pars, bandObject, T_array, rhozz_data):
    ...
    print("Generate one curve rho_zz time : %.6s seconds" % (time.time() - start_total_time))

    diff = rhozz_data - rhozz_fit
...
## Run fit algorithm
out = minimize(residualFunc, pars, args=(bandObject, T_array, rhozz_data))
