...
B_amp = 0.08 * t
half_FS_z = False
mesh_xy = 104 # 28 must be a multiple of 4
mesh_z = 101 # 11 ideal to be fast and accurate
mesh_B_theta = 31
...
kft, vft, t = solve_movement_func(B_amp, B_theta, B_phi, kf, band_parameters, tmax = 10 * tau)
