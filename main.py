...
condObject = Conductivity(bandObject, Bamp=45, gamma_0=15, gamma_dos=0, gamma_k=67.9, power=12)
...
# hPocketCondObject = Conductivity(hPocket, Bamp=45, gamma_0=15, gamma_k=0, power=12, gamma_dos=0)
